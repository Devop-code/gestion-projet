...
export type Database = {
  public: {
    Tables: {
      ...
      session_reports: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "session_reports_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "session_reports_validated_by_fkey"
    ...
    Enums: {
      project_type: "group_project" | "internship_report"
      task_status: "pending" | "in_progress" | "completed"
      user_role: "admin" | "student" | "supervisor"
    }
    CompositeTypes: {
      [_ in never]: never
    }
